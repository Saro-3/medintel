...
CREATE TABLE `medicine_indications` (
  ...
  CONSTRAINT `medicine_indications_ibfk_1` FOREIGN KEY (`medicine_id`) REFERENCES `medicines` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `medicine_indications` VALUES (1,1,'Throat infections (pharyngitis, tonsillitis)'),(2,1,'Bronchitis'),(3,1,'Pneumonia'),(4,1,'Ear infections'),(5,1,'Skin and soft tissue infections'),(6,1,'Chlamydia and other STDs'),(7,1,'Typhoid fever');
